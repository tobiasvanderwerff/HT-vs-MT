...
# checkpoint_dir=/data/pg-macocu/MT_vs_HT/experiments/2/models/${log_model_name}_lr=1e-05_bsz=32_seed=1/checkpoint-2800
# checkpoint_dir=/data/pg-macocu/MT_vs_HT/experiments/2/models/${log_model_name}_lr=1e-05_bsz=32_seed=2/checkpoint-2200
checkpoint_dir=/data/pg-macocu/MT_vs_HT/experiments/2/models/${log_model_name}_lr=1e-05_bsz=32_seed=3/checkpoint-2800
